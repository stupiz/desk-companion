...
void Arduino_AXS15231::setRotation(uint8_t r)
{
    ...
    uint8_t madctl = AXS15231_MADCTL_COLOR_ORDER;
    switch (_rotation & 0x03)
    {
    case 0:
        break;
    case 1:
        madctl |= AXS15231_MADCTL_MX | AXS15231_MADCTL_MV;
        break;
    case 2:
        madctl |= AXS15231_MADCTL_MX | AXS15231_MADCTL_MY;
        break;
    case 3:
        madctl |= AXS15231_MADCTL_MY | AXS15231_MADCTL_MV;
        break;
    ...
    _bus->beginWrite();
    _bus->writeC8D8(AXS15231_W_MADCTL, madctl);
    _bus->endWrite();
}
